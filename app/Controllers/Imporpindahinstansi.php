...
class Imporpindahinstansi extends BaseController
{
    protected $model;
    ...
    public function index()
    {
        if (isset($_POST['submit'])) {
            ...
            if ($form_errors) {
                ...
                $this->data['message'] = $this->model->imporpindahinstansi();
            } 
        }

        $this->data['dropdowninstansi'] = $this->model->get_all_instansi();
        $this->data['get_history_import'] = $this->model->get_history_import('tbl_pindah_instansi');

        $this->view('imporpindahinstansi.php', $this->data);
    }
