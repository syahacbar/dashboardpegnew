...
class Dashboardadmin extends BaseController
{
	...
	public function index()
	{
		...
		$this->data['count_pensiun_all'] = $this->model->count_pensiun_all();
		$this->data['count_pegawai_by_instansi'] = $this->model->count_pegawai_by_instansi();
		...
		$this->view('dashboard_admin.php', $this->data);
	}
