	...
	public function getDataDT() {
		...
		foreach ($query['data'] as $key => &$val) 
		{
			...
			$val['ignore_action'] = '<div class="btn-action-group">'.
									btn_label(['url' => $this->config->baseURL . 'builtin/module-role/edit?id=' . $val['id_module'], 'label' => 'Edit', 'icon' => 'fas fa-edit', 
												'attr' => ['class' => 'btn btn-success btn-xs me-2', 'target' => '_blank']]
											). 
									btn_label(['url' => $this->config->baseURL . 'builtin/module-role/detail?id=' . $val['id_module'], 'label' => 'Detail', 'icon' => 'fas fa-eye', 
