    ...
    <div class="col-12 col-md-12 col-lg-12 col-xl-4 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Impor Data Pensiun</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <div class="mt-1">Contoh file: <a title="Contoh Format Data Pensiun" href="<?= $config->baseURL ?>public/files/format_pensiun.xlsx">Format Data Pensiun</a></div>
...
$('.impordata-toogle').change(function() {
    ...
    $.ajax({
      type:'POST',
      dataType:'JSON',
      url:'<?php echo base_url() ?>/imporpensiun/statusaktif',
