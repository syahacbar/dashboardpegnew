		...
		<div class="menu-wrapper wrapper clearfix">
			...
			<div class="nav-left">
				<a href="" class="logo-header" title="Jagowebdev">
					<img src="<?=$config->baseURL?>public/images/logodashboadpeg.png" alt="Dashboard Kepegawaian"/>
				</a>
			</div>
	...
	<footer>
		...
		<div class="wrapper">
			<div class="row mb-0">
				<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mb-2">
					...
					<li><i class="fas fa-file-signature me-2"></i><a target="_blank" href="https://manokwariweb.com/">Via Contac form</a></li>
					</ul>
				</div>
				<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mb-2">
					...
					<ul class="list">
						<li><i class="fab fa-facebook-square me-2"></i><a href="https://web.facebook.com/manokwariweb" target="_blank">facebook</a></li>
					</ul>
				</div>
				<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
					<h2 class="widget-title">More Info</h2>
					<ul class="list">
						<li><i class="fa fa-user-plus me-2"></i><a href="https://manokwariweb.com" target="_blank">Premium Member</a></li>
						<li><i class="fas fa-external-link-alt me-2"></i><a href="http://manokwariweb.com/" target="_blank">Artikel Blog</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="footer-menu-container">
			<div class="wrapper clearfix">
				<div class="nav-left">Copyright &copy; 2023 <a title="Manokwari Web" href="https://manokwariweb.com">Jagowebdev</a>
				</div>
