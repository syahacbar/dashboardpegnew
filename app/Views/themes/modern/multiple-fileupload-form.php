	...
	<div class="card-body">
		...
		<form method="post" action="" id="form-container" enctype="multipart/form-data">
			<div class="tab-content" id="form-container">
				...
				<div class="row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Minuta</label>
					<div class="col-sm-5">
						<?php
						echo options(['name' => 'minuta']
										, ['Y' => 'Ya', 'N' => 'Tidak']
										, set_value('minuta', @$minuta)
									);
						?>
					</div>
				</div>
				<div class="row mb-3">
					...
					<div class="col-sm-5">
						...
						if (!$penghadap) {
							...
							echo options(['class' => 'form-control nama-penghadap select2'
											, 'name' => 'id_penghadap[]'
											, 'multiple' => 'multiple'
											, 'required' => 'required'
											]
				...
				<div class="row mb-3">
					...
					<div class="col-sm-5">
						...
						if (!$penanggungjawab) {
							...
							echo options(['class' => 'form-control penanggung-jawab select2'
				...
				<div class="row mb-3">
					...
					<div class="col-sm-5"> 
						<div class="mt-2">
							<div style="display:none">
								...
								<input type="file" class="file form-control" name="nama_file[]" style="display:block">
					...
					if (!empty($nama_file)) {
						foreach ($nama_file as $key_data => $val_data) {
							if (file_exists(ROOTPATH . '/public/files/dokumen/' . $val_data)){
								$nama_file = $val_data;
