	...
	<div class="row">
			...
			<div class="card text-bg-primary shadow">
				<div class="card-body card-stats">
					<div class="description">
						<h5 class="card-title h4"><?php echo $pegawai->totalpegawaiinstansi; ?></h5>
		...
		<div class="col-lg-3 col-sm-6 col-xs-12 mb-4">
			<div class="card text-white bg-success shadow">
				<div class="card-body card-stats">
					<div class="description">
						<h5 class="card-title h4"><?php echo format_ribuan($totalukp->jum_ukp); ?></h5>
		...
		<div class="col-lg-3 col-sm-6 col-xs-12 mb-4">
			<div class="card text-white bg-warning shadow">
				<div class="card-body card-stats">
					<div class="description">
						<h5 class="card-title h4"><?php echo format_ribuan($totalpi->jum_upi); ?></h5>
		...
		<div class="col-lg-3 col-sm-6 col-xs-12 mb-4">
			<div class="card text-white bg-danger shadow">
				<div class="card-body card-stats">
					<div class="description">
						<h5 class="card-title h4"><?php echo format_ribuan($totalpensiun->jum_upensiun); ?></h5>
	...
	<div class="row">
		<div class="col-12 col-md-12 col-lg-12 col-xl-4 mb-4">
			<div class="card">
				<div class="card-header">
					<div class="card-header-start">
						<h6 class="card-title">Status Pengusulan Pindah Instansi</h6>
					</div>
				</div>
				<div class="card-body">
					<div style="overflow: auto">
						<table class="table table-striped table-bordered table-hover mytables">
							...
							<tr>
								<td>-</td>
								<td>TMS</td>
								<td style="text-align: center;"><?php echo $totalpiTMS->countstatus; ?></td>
							</tr>
							<tr>
								<td>-</td>
								<td>BMS</td>
							...
							<tr>
								<td>-</td>
								<td>MS</td>
								<td style="text-align: center;"><?php echo $totalpiMS->countstatus; ?></td>
							</tr>
							<tr>
								<td colspan="2">Dalam Proses Validasi</td>
								<td style="text-align: center;"><?php echo $totalpiDalamProses->countstatus; ?></td>
							</tr>

							</tbody>
								<tfoot>
									<th style="text-align: center;" colspan="2">Total</th>
									<th style="text-align: center;"><?php echo format_ribuan($totalpi->jum_upi); ?></th>
								</tfoot>
						</table>
					</div>
				</div>
	...
	<div class="row">
		<div class="col-12 col-md-12 col-lg-12 col-xl-4 mb-4">
			<div class="card">
				<div class="card-header">
					<div class="card-header-start">
						<h6 class="card-title">Status Pengusulan Pensiun</h6>
					</div>
				</div>
				<div class="card-body">
					<div style="overflow: auto">
						<table class="table table-striped table-bordered table-hover mytables">
							...
							<tr>
								<td>-</td>
								<td>TMS</td>
								<td style="text-align: center;"><?php echo $totalpensiunTMS->countstatus; ?></td>
							</tr>
							<tr>
								<td>-</td>
								<td>BMS</td>
							...
							<tr>
								<td>-</td>
								<td>MS</td>
								<td style="text-align: center;"><?php echo $totalpensiunMS->countstatus; ?></td>
							</tr>
							<tr>
								<td colspan="2">Dalam Proses Validasi</td>
								<td style="text-align: center;"><?php echo $totalpensiunDalamProses->countstatus; ?></td>
							</tr>

							</tbody>
								<tfoot>
									<th style="text-align: center;" colspan="2">Total</th>
									<th style="text-align: center;"><?php echo format_ribuan($totalpensiun->jum_upensiun); ?></th>
								</tfoot>
						</table>
					</div>
				</div>
		...
		<div class="col-12 col-md-12 col-lg-12 col-xl-8 mb-4">
			<div class="card" style="height:100%">
				<div class="card-body" style="display:flex">
					<figure class="highcharts-figure" style="min-width:500px;margin:top;width:100%;">
					    <div id="graph-usulanpensiun"></div>
					</figure>
				</div>
			</div>
		</div>
...
<script> 
	...
	var total = <?=$pegawai->totalpegawaiinstansi;?>;
		...
		//graph status usulan PI
	
		chart5 = new Highcharts.Chart({
		    chart: {
		    	renderTo: 'graph-usulanpi',
		        type: 'pie',
		        options3d: {
		            enabled: true,
		            alpha: 45,
		    ...
		    title: {
		        text: 'Status Usulan Pindah Instansi',
		        align: 'left'
		    },
		    accessibility: {
		        point: {
		    ...
		    series: [{
		        type: 'pie',
		        name: 'Jumlah',
		        data: [<?php foreach($usulanpi AS $upi){ echo "['".$upi->status."',".$upi->jum_upi."],"; }?>
		        ]
		    }]
		});


		//graph status usulan pensiun
	
		chart6 = new Highcharts.Chart({
		    chart: {
		    	renderTo: 'graph-usulanpensiun',
		        type: 'pie',
		        options3d: {
		            enabled: true,
		            alpha: 45,
		    ...
		    series: [{
		        type: 'pie',
		        name: 'Jumlah',
		        data: [<?php foreach($usulanpensiun AS $upensiun){ echo "['".$upensiun->status_usulan."',".$upensiun->jum_upensiun."],"; }?>
		        ]
		    }]
		});
